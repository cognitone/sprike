...
public:
    ...
    void setSynth(PluginProcessor *processor, eTfSynth *synth, eTfInstrument *instr);
...
{
public:
     PluginEditor (PluginProcessor* ownerFilter, eTfSynth *synth);
    ~PluginEditor();
...
private:
    ...
    String explodeString (const String& str);
    ...
    void _createIcons();
    void _resetTimer();
    bool _isEffectUsed(eU32 effectNum);
    ...
    ComboBox m_cmbDelayLeftGrid;
    ComboBox m_cmbDelayRightGrid;
    ...
    LevelMeter  m_meter;
    eTfSlider   m_sldMasterPan;
    Label       m_lblMasterPan;
    eTfSlider   m_sldMasterVolume;
    Label       m_lblMasterVolume;
};
